...
const BOTS_MSGS = [
  ...
  'This activity log will guide you and is available from your Contacts list or by swiping right or by clicking the〈 above.',// 'You created your first decentralized ID (called a DID)!',
